...
<form:form method="POST" action="/bookaroom" commandName="book">
   <table>
    ...
    <tr>
        <td><form:label path="checkinDate">Checkin Date<small>(mm/dd/yyyy)</small></form:label></td>
    ...
    <tr>
        <td><form:label path="checkoutDate">Checkout Date<small>(mm/dd/yyyy)</small></form:label></td>
